...
int main(int cArg, char** argS)
{
	...
	do {
		...
		addDefKV(aDefArgMap, "procId=512");
		addDefKV(aDefArgMap, "runWorkNum=worker:0*1*0*10-1*1*1*10+routeWorker:1");
		addDefKV(aDefArgMap, "netNum=4");
		addDefKV(aDefArgMap, "appNetType=2");
		addDefKV(aDefArgMap, "appGroupId =2");
		addDefKV(aDefArgMap, "projectInstallDir=C:/work/appFrameInstall");
		addDefKV(aDefArgMap, "netLib=libeventSession");
		addDefKV(aDefArgMap, "logFile=taskServer.log");
		addDefKV(aDefArgMap, "level0=cppLevel0L ");
		addDefKV(aDefArgMap, "frameHome=C:/work/appFrameInstall");
		addDefKV(aDefArgMap, "frameConfigFile=taskServerframeConfig.txt");
